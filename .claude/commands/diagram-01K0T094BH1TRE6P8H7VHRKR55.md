---
runme:
  id: 01K0T881SBC8V3V34X2PV8YH5C
  version: v3
  document:
    relativePath: diagram.md
  session:
    id: 01K0T094BH1TRE6P8H7VHRKR55
    updated: 2025-07-23 02:42:15+03:00
---
...
```ini {"id":"01K0T881SA0B9M6A4GDYKPGGDM"}
...
```bash {"id":"01K0T881SBC8V3V34X1YMGGECS"}
...
```ini {"id":"01K0T881SBC8V3V34X227Z4KZA"}
┌─────────────────────────────────────────────────────────────┐
...
```ini {"id":"01K0T881SBC8V3V34X2AZP650W"}
┌─────────────────┐         ┌─────────────────┐
│     users       │         │    orders       │
├─────────────────┤         ├─────────────────┤
│ id          PK  │────┐    │ id          PK  │
...
```ini {"id":"01K0T881SBC8V3V34X2BEJN50R"}
┌───────────────────────────────────────────────────┐
│                  Frontend Layer                    │
│  ┌─────────────┐ ┌──────────────┐ ┌────────────┐ │
...
```typescript {"id":"01K0T881SBC8V3V34X2EC06YKB"}
// generate-diagram.ts
...
```html {"id":"01K0T881SBC8V3V34X2EEWP8HG"}
<!-- For web output -->
...
```markdown {"id":"01K0T881SBC8V3V34X2JB9MS92"}
# ${DiagramType} Diagram
